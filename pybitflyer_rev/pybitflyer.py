...
class API(object):
        ...
        try:
            with requests.Session() as s:
                ...
                if method == "GET":
                    ...
                    self.response_code = response.status_code #改造点
                else:  # method == "POST":
    ...
    #Added market(),comission_rate to original version.
    def commission_rate(self, **params):
        """Order Book
    ...
    def market(self, **params):
        ...
        #endpoint = "/v1/markets" #or you can also use this endpoint
        return self.request(endpoint, params=params)
